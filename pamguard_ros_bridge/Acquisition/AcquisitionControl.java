 ...
 *
 */
public class AcquisitionControl extends PamControlledUnit implements PamSettings, OfflineDataStore{
...
//		if (PamguardVersionInfo.getReleaseType() == PamguardVersionInfo.RELEASE_BETA ||
//				PamguardVersionInfo.getReleaseType() == PamguardVersionInfo.RELEASE_SMRU) {
//			registerDaqSystem(new SimulatedSoundSystem());
//		}
...
//			statusBar.getToolBar().invalidate();
	...
	@Override
	public boolean loadData(PamDataBlock dataBlock, long dataStart, long dataEnd, RequestCancellationObject cancellationObject) {
		return offlineFileServer.loadData(dataBlock, dataStart, dataEnd, cancellationObject);
	}
	@Override
