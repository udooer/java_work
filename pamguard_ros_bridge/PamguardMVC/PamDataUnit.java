...
//	public GpsDataUnit gpsDataUnit;
	 ...
	 * this detection. 
	 * @param recalculate
	 * @return Lat long of detectin origin (usually the position of the reference hydrophone at time of detection)
	 */
...
//						firstPhone, HydrophoneLocator.ANGLE_RE_NORTH);
		...
		if (nPhones == 0) {
			...
			oLL = new LatLong(totalLat / nPhones, totalLong / nPhones);
		}
//		if (nPhones >= 2) {
