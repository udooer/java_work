...
public class OfflineFileServer implements OfflineDataStore, PamSettings {
	...
	public OfflineFileServer(AcquisitionControl acquisitionControl) {
		...
		rawDataBlock = acquisitionControl.getAcquisitionProcess().getRawDataBlock();
...
//			}
	...
	private void addToMap(File folderName, boolean includeSubFolders) {
		PamFileFilter audioFileFilter = acquisitionControl.getFolderSystem().getAudioFileFilter();
	...
	private void addToMap(File file) {
		 ...
		 * 
		 */
		long startTime = fileDate.getTimeFromFile(file);
